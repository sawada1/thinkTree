            ...
            <div class="grid grid-cols-1 gap-10 xl:grid-cols-2 lg:grid-cols-2">
                <div data-aos="fade-left"  class="form-container flex flex-col gap-5 border-[#E1E3E5] border-[1px] p-[16px] rounded-[8px]">
                  <div class="input flex flex-col gap-3">
                    ...
                    <input type="text" v-model="parent_name" class="outline-none border-[#E1E3E5] border-[1px] rounded-[4px] p-1" name="" id="">
                  ...
                  <div class="input flex flex-col gap-3">
                    ...
                    <input type="text" v-model="child_name" class="outline-none border-[#E1E3E5] border-[1px] rounded-[4px] p-1" name="" id="">
                  ...
                  <div class="input flex flex-col gap-3">
                    ...
                    <input type="text" v-model="phone" class="outline-none border-[#E1E3E5] border-[1px] rounded-[4px] p-1" name="" id="">
                  ...
                  <div class="input flex flex-col gap-3">
                    ...
                    <textarea rows="5" v-model="message"  class="outline-none border-[#E1E3E5] border-[1px] rounded-[4px] p-1" name="" style="resize: none;" id=""/>
                ...
                <img data-aos="fade-right"  src="/images/contact.png" alt="">
            </div>
