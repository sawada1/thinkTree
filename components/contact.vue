<template>
  <div class="container mt-[120px] mb-[70px]">
    <h6 class="text-primary text-center mb-8 xl:text-[32px] lg:text-[32px] text-[26px] font-bold"> {{ $t('contact1') }}
    </h6>
    <div class="grid grid-cols-1 gap-14 xl:grid-cols-2 lg:grid-cols-2">
      <div data-aos="fade-left"
        ...
        <div class="input flex flex-col gap-3">
          ...
          <input type="text" v-model="parent_name" class="outline-none border-[#E1E3E5] border-[1px] rounded-[4px] p-1"
            name="nameInput" id="nameInput">
        ...
        <div class="input flex flex-col gap-3">
          ...
          <input type="text" v-model="child_name" class="outline-none border-[#E1E3E5] border-[1px] rounded-[4px] p-1"
            name="name2Input" id="name2Input">
        ...
        <div class="input flex flex-col gap-3">
          ...
          <textarea rows="5" v-model="message" class="outline-none border-[#E1E3E5] border-[1px] rounded-[4px] p-1"
            name="messageInput" style="resize: none;" id="messageInput" />
      ...
      <NuxtImg data-aos="fade-right" format="webp" quality="80" class="w-full" loading="lazy" src="/images/contact.png"
